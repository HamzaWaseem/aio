...
class CarMaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_maintenance" do
    assert_difference('CarMaintenance.count') do
      post car_maintenances_url, params: { car_maintenance: { body: @car_maintenance.body, published_at: @car_maintenance.published_at, rates: @car_maintenance.rates, title: @car_maintenance.title } }
    end
  ...
  test "should update car_maintenance" do
    patch car_maintenance_url(@car_maintenance), params: { car_maintenance: { body: @car_maintenance.body, published_at: @car_maintenance.published_at, rates: @car_maintenance.rates, title: @car_maintenance.title } }
